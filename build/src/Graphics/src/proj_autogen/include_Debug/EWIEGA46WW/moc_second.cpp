...
#include "../../../../../../../src/Graphics/src/second.h"
...
QT_MOC_LITERAL(1, 7, 9), // "openFirst"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 5) // "openF"

    },
    "second\0openFirst\0\0openF"
};
...
void second::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->openFirst(); break;
        case 1: _t->openF(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (second::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&second::openFirst)) {
                *result = 0;
                return;
            }
        }
